    ...
    <main className={styles.page}>
      <div className={styles.container}>
        ...
        <div className={styles.card}>
          ...
          <p>
            Meno, e-mailová adresa, telefónne číslo a ďalšie údaje,
            ktoré nám dobrovoľne poskytnete pri rezervácii služby
            alebo komunikácii.
          </p>
          ...
          <p>
            Údaje používame výlučne za účelom komunikácie,
            rezervácie termínov a poskytovania služieb.
          </p>
          ...
          <p>
            Máte právo požiadať o prístup k údajom,
            ich opravu, vymazanie alebo obmedzenie spracovania.
          </p>
        </div>
      </div>
    </main>
